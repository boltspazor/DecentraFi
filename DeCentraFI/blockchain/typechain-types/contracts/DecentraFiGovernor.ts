...
export interface DecentraFiGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface DecentraFiGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): DecentraFiGovernor;
  waitForDeployment(): Promise<this>;

  interface: DecentraFiGovernorInterface;
