...
export interface DecentraFiTimelockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DecentraFiTimelock extends BaseContract {
  connect(runner?: ContractRunner | null): DecentraFiTimelock;
  waitForDeployment(): Promise<this>;

  interface: DecentraFiTimelockInterface;
