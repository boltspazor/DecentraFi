...
export interface DecentraFiGovernanceTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface DecentraFiGovernanceToken extends BaseContract {
  connect(runner?: ContractRunner | null): DecentraFiGovernanceToken;
  waitForDeployment(): Promise<this>;

  interface: DecentraFiGovernanceTokenInterface;
