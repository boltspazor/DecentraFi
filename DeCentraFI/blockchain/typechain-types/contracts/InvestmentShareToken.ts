...
export interface InvestmentShareTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface InvestmentShareToken extends BaseContract {
  connect(runner?: ContractRunner | null): InvestmentShareToken;
  waitForDeployment(): Promise<this>;

  interface: InvestmentShareTokenInterface;
